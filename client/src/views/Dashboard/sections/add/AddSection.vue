                ...
                <div class="row mb-3">
                  <div class="col-lg-12 col-md-12 my-2">
                    ...
                    <div class="profile_card" v-if="selectedUser">
                        <img 
                        class="profile_pic"
                        :src="selectedUser.profilePic ? `http://www.localhost:4000/api/v1/${selectedUser.profilePic.link}`:'https://images.pexels.com/photos/14270861/pexels-photo-14270861.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'" alt="" srcset="">
                    </div>
                    <!-- Profile Details End -->
                  </div>
                  ...
                  <tr v-for="(row, key) in section_details" :key="key">
                    ...
                    <td>
                      <span
                        ...
                        v-if="row.get_user.status == true"
                        >Active</span
                      >
                      <span
                        class="badge bg-danger"
                        v-if="row.get_user.status == false"
                        >Block</span
                      >
                    </td>
                    <td>
                      <span
                        class="badge bg-success"
                        v-if="row.get_user.completed == true"
                        >Completed</span
                      >
                      <span
                        class="badge bg-danger"
                        v-if="row.get_user.completed == false"
                        >Not Completed</span
                      >
                    </td>
