      ...
      <div class="row">
        <div class="col-lg-6 col-md-12 py-5">
          <div class="container py-5">
            ...
            <form>
              <div class="alert alert-danger" v-if="state.errorMessage">
                {{ state.errorMessage }}
              </div>
              ...
              <div class="mb-4">
                ...
                <input
                  ...
                  class="form-control"
                  v-model="state.email"
                  :class="v$.email.$error ? 'error' : null"
                />
              </div>
              <button
                type="submit"
                class="btn form-control mt-2 login-button"
        ...
        <div class="col-lg-6 col-md-12" id="img"></div>
      </div>
    </div>
  </section>
</template>
      ...
      return {
        email: {
          ...
          email: helpers.withMessage(
            "The email you typed is not a valid email address",
            email
          ),
        },
      };
  ...
  methods: {
    validation() {
      ...
      if (!this.v$.$error) {
        ...
        axios
          .post("auth/email-verification", { email: this.state.email })
          .then((response) => {
